...
#define ZFG_MASK_HEADSET_DETECT_STABLE 
...
#ifdef ZFG_MASK_HEADSET_DETECT_STABLE                   /*    more button more error!!!!!!!     */
				 ...
				 bool enable)
{
	...
	pr_err("%s: irq: %d, enable: %d, intr_status:%lu\n",
				...
				enum snd_jack_types jack_type)
{
	...
	pr_err("%s: enter insertion %d hph_status %x jack_type: %x mbhc->current_plug :%x\n",
...
exit:
 ...
 #if 0
   #ifndef CONFIG_ZFG_AW87319_PA 
      #ifndef CONFIG_ZFG_AW8736_PA
if (mbhc->mbhc_cfg->detect_extn_cable &&
	    ((plug_type == MBHC_PLUG_TYPE_HEADPHONE) ||
	     (plug_type == MBHC_PLUG_TYPE_HEADSET)) &&
	    !mbhc->hs_detect_work_stop) {
