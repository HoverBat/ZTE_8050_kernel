...
static unsigned char CTPM_FW_LC[] = {
	#include "FT_Upgrade_App_Lianchuang.i"
};
...
int fts_5x36_ctpm_fw_upgrade(struct i2c_client *client, u8 *pbt_buf, u32 dw_lenth)
{
	...
	else if(fw_vendor_id == FTS_VENDOR_ID_LIANCHUANG)	
	{	    
		CTPM_FW = CTPM_FW_LC;	    
		fw_filenth = sizeof(CTPM_FW_LC);	
	}
